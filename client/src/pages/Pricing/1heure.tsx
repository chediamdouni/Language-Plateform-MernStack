  ...
  const calculatePrice = (selectedValue: string) => {
    ...
    switch (selectedValue) {
      case "monthly":
        ...
        break;
      case "quarter":
        const reductionQ = 852 * 0.1;
        TotalpricePerQuarter = parseInt((71 * 12 - reductionQ).toFixed(0));
        break;
      case "annual":
        const reductionA = (708 * 25) / 100;
        TotalpricePerYear = parseInt((59 * 12 - reductionA).toFixed(0));
        break;
      default:
        break;
    }
