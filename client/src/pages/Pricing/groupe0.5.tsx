  ...
  const calculatePrice = (selectedValue: string) => {
    ...
    switch (selectedValue) {
      case "monthly":
        ...
        break;
      case "quarter":
        const reductionQ = 228 * 0.1;
        TotalpricePerQuarter = parseInt((19 * 12 - reductionQ).toFixed(0));
        break;
      case "annual":
        const reductionA = (192 * 25) / 100;
        TotalpricePerYear = parseInt((16 * 12 - reductionA).toFixed(0));
        break;
      default:
        break;
    }
