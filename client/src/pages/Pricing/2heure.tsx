  ...
  const calculatePrice = (selectedValue: string) => {
    ...
    switch (selectedValue) {
      case "monthly":
        ...
        break;
      case "quarter":
        const reductionQ = 1608 * 0.1;
        TotalpricePerQuarter = parseInt((134 * 12 - reductionQ).toFixed(0));
        break;
      case "annual":
        const reductionA = (1344 * 25) / 100;
        TotalpricePerYear = parseInt((112 * 12 - reductionA).toFixed(0));
        break;
      default:
        break;
    }
